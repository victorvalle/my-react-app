    ...
    <div className="Hero">
      <div className="TopArea">
        <div className="Illustration">
          ...
          <svg
            ...
            <g clipPath="url(#a)" data-name="background circle mask">
      ...
      <div className="History">
        ...
        <div className="tile">
          ...
          <div class="right">
            <p className="highlight">Queremos que nos acompañes en nuestro gran día porque sin ti no sería lo mismo. Y lo decimos de verdad, así que no te olvides de confirmárnoslo y no pierdas los detalles a continuación:</p>
            <br/>
            <br/>
            <div>
