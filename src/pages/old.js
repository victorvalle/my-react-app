...
import { FancyHrOld, HeaderOld, ButtonOld, Link, StickyCTA } from '../components'
		...
		<section className={styles.History}>
			...
			<div className={styles.tile}>
				...
				<div className={`${styles.right} ${styles.map}`}>
					<img
						alt=""
						src={require('../images/camino-old.png')}
						width="100%"
					/>
				</div>
			</div>
			...
			<img
				...
				src={require('../images/OurTrip-old.png')}
				width="100%"
			/>
			<img
				alt=""
				className={styles.ourTripSm}
				src={require('../images/OurTripSmall-old.png')}
				width="100%"
			/>
		</section>
		{/* <section className={styles.yourTurn}>
			...
			<div className={styles.tile}>
				<div className={styles.calendario}>
					<img
						alt=""
						src={require('../images/calendario-old.png')}
						width="100%"
					/>
					<br />
					<br />
				...
				<div class="right">
					...
					<div>
						<img
							alt=""
							src={require('../images/map-point-old.png')}
							height="50px"
						/>
						<p>
							En{' '}
					...
					<div>
						<img
							alt=""
							src={require('../images/bus-old.png')}
							height="50px"
						/>
						<p>
					...
					<div>
						<img
							alt=""
							src={require('../images/spotify-old.png')}
							height="50px"
						/>
						<p>
					...
					<div>
						<img
							alt=""
							src={require('../images/gift-old.png')}
							height="50px"
						/>
						<p>
